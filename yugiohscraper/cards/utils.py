...
def core_qcr_calculate_odds_per_booster_box(set_cards):
    ...
    # print(f"Quarter Century Secret Rare: {probability_qcsr:.2%}")
    ...
    # print(f"Quarter Century Secret Rare: {probability_specific_qcsr:.8%}")
...
core_qcr_calculate_odds_per_booster_box(phni)